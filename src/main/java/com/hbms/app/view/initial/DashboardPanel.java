...
public class DashboardPanel extends JPanel {
    ...
    public DashboardPanel(MainFrame mainFrame, BookingController bookingController, HallController hallController, IssueController issueController, UserController userController){
        ...
        hallsPanel = new HallsPanel(mainFrame, bookingController, hallController);
