...
public class BookHallDialog extends JDialog {
    private JLabel lblMessage;

    public BookHallDialog(JFrame parentFrame, Hall hall, BookingController bookingController, ReceiptController receiptController) {
